...
\
\
The [RDM LibGuide](https://libguides.vu.nl/rdm/data-documentation){target="_blank"} describes the elements that are essential for  a good codebook. You should also aim to include in your codebook (where applicable):
