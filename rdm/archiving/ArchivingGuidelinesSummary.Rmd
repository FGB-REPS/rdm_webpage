...
**NB: The guidelines summarized here refer specifically to [data archiving](../definitions/Definitions.html#archivingdata){target="_blank"} and some elements of [data publishing](../definitions/Definitions.html#publishingdata){target="_blank"}, but they do not address the complexities involved with the [reuse](../definitions/Definitions.html#reusedata){target="_blank"} of data by third parties.**
...
-->
The vast majority of data used within the faculty is considered [personal data](../definitions/Definitions.html#personaldata){target="_blank"} and therefore should be stored in a secure archive. The default archive at FGB for most situations and data types is [YODA](../tools/YODAInstructionsFGB.html){target="_blank"}. Following this [YODA archiving checklist](../../Images/meta_archiving_guide_yoda.docx) to ensure that you are archiving everything that needs to be archived in YODA in the correct way.
