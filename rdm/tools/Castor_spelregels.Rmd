...
* You are strongly advised to read the Castor manual, particularly the [EDC manual](https://helpdesk.castoredc.com/en_US/2-castor-edc-manual){target="_blank"}
    + The following sections are particularly important:
        ...
        + [Castor EDC/CMDS Tips and tricks - Before starting](https://helpdesk.castoredc.com/en_US/2-introduction-and-getting-started/tips-and-tricks-before-starting){target="_blank"}
...
* When you complete your research you should follow the [Castor guidance](https://helpdesk.castoredc.com/can-i-lock-and-archive-my-study-once-it-is-complete?from_search=99167795){target="_blank"} on ending a study. Additionally you must do the following:
    ...
    + Once all of the data have been securely stored or archived at the VU, contact [Castor Support](https://helpdesk.castoredc.com/contact-us){target="_blank"} to have all of the data stored by Castor deleted. Otherwise the data will be automatically stored on Castor's servers for 25 years.
