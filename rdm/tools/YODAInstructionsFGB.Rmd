...
As a starting point, you can use this [YODA archiving checklist](../../Images/meta_archiving_guide_yoda.docx) to make sure you've done all the necessary steps to archive data in YODA. The following information goes into even further detail if you need it.
