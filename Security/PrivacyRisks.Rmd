...
| _Example_ | &bull; Video interviews with children talking about abuse  |
...
| _Example_ | &bull;	Key files containing names and contact information of healthy adults |
...
| _Example_ | &bull;	IP- and MAC-addresses of healthy adults |
...
| _Example_ | &bull; Highly variable physical measurements (e.g. blood pressure, heart rate, blood glucose, body temperature) from healthy adults |
