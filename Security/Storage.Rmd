...
OneDrive is generally discouraged for the storage of research data and related materials because like SURFdrive, it is tied entirely to you as an individual. If something happens to you or you stop working at the VU, all access to the materials stored on your OneDrive will be lost, even if you shared some folders with colleagues. In all cases, **OneDrive should not be used for "Red" or "Orange" data**. OneDrive should also not be used for storing files managed by git or other version control software, such as your research code. The syncing functionalities of OneDrive do not work well with version control, especially when pushing to remote repositories, such as GitHub.
