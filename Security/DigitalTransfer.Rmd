...
If you are using [Research Drive](https://services.vu.nl/esc?id=kb_article&sysparm_article=KB0012856){target="_blank"} for data storage and you need to share the data with a research collaborator or research team member, you can add the user who needs access using these [instructions](https://servicedesk.surf.nl/wiki/spaces/WIKI/pages/128909585/RD+Set+permissions+when+sharing+files+and+folders){target="_blank"}.
...
* Ensure that the recipient has appropriate [access rights](https://servicedesk.surf.nl/wiki/spaces/WIKI/pages/128909585/RD+Set+permissions+when+sharing+files+and+folders){target="_blank"} (i.e. whether they can only read files or also modify/upload files). 
...
If you are using [Research Drive](https://services.vu.nl/esc?id=kb_article&sysparm_article=KB0012856){target="_blank"} for data storage and you need to share the data with a research collaborator or research team member, you can add the user who needs access using these [instructions](https://servicedesk.surf.nl/wiki/spaces/WIKI/pages/128909585/RD+Set+permissions+when+sharing+files+and+folders){target="_blank"}. [SURFdrive](https://services.vu.nl/esc?id=kb_article&sysparm_article=KB0012728){target="_blank"} can also be used to share "yellow" data. Any user that can log into SURFconnext can be given access to a SURFdrive file or folder. 
...
**NB**: SURFdrive is generally discouraged for ongoing storage of research data (see the [Secure Storage Guide](Storage.html#nonpreferred){target="_blank"} for more information). If you are sharing data with research collaborators, Research Drive or YODA are the preferred options. 
  ...
  * Make sure the added user knows how to work safely in [Research Drive](Storage.html#preferred){target="_blank"} or [SURFdrive](Storage.html#nonpreferred){target="_blank"}. 
      ...
      * The recipient must ensure that they always have [full-disk encryption](Encryption.html#fde){target="_blank"} activated on their computer.
  * Ensure that the recipient will **only** have access to the files that they need to see. If you give them access to a folder, they will have access to all subfolders within that folder.
  * Ensure that the recipient has appropriate [access rights](https://servicedesk.surf.nl/wiki/spaces/WIKI/pages/128909585/RD+Set+permissions+when+sharing+files+and+folders){target="_blank"} (i.e. whether they can only read files or also modify and/or upload files). 
...
If you are using [Research Drive](https://services.vu.nl/esc?id=kb_article&sysparm_article=KB0012856){target="_blank"} for data storage and you need to share the data with a research collaborator or research team member, you can add the user who needs access using these [instructions](https://servicedesk.surf.nl/wiki/spaces/WIKI/pages/128909585/RD+Set+permissions+when+sharing+files+and+folders){target="_blank"}. [SURFdrive](https://services.vu.nl/esc?id=kb_article&sysparm_article=KB0012728){target="_blank"} can also be used to share "green" data. Any user that can log into SURFconnext can be given access to a SURFdrive file or folder. 
