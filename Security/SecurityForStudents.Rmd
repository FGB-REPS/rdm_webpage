...
If your "Red" data have been approved for storage in YODA, you can [add the student(s) to the YODA "group" you manage](https://rdm.vu.nl/manuals/yoda/yoda_portal/group_manager.html){target="_blank"}
...
If you are already storing "Orange" data in [YODA](../rdm/tools/YODAInstructionsFGB.html){target="_blank"}, you can [add the student(s) to the YODA "group" you manage](https://rdm.vu.nl/manuals/yoda/yoda_portal/group_manager.html){target="_blank"} to provide them access to "Orange" data.
...
If you are already storing "Yellow" data in [YODA](../rdm/tools/YODAInstructionsFGB.html){target="_blank"}, you can [add the student(s) to the YODA "group" you manage](https://rdm.vu.nl/manuals/yoda/yoda_portal/group_manager.html){target="_blank"} to provide them access to "Yellow" data.
...
For faculty-level support, contact the Technical Support for Research (TO3) [Helpdesk](https://vu.nl/en/employee/research-support/technical-support-for-research-fgb-to3){target="_blank"}. They can provide [equipment](PhysicalTransport.html#to3){target="_blank"} for short-term data collection and storage, such as encrypted external hard drives, and if given sufficient notice, they can develop solutions for more complex research projects.
