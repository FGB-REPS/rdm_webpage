...
If the advice described in this document is not feasible for your research, contact the [TO3 technicians](https://vu.nl/en/employee/research-support/technical-support-for-research-fgb-to3){target="_blank"} as soon as possible to discuss possible alternatives. If they cannot assist you, you can get support from VU IT Security via the [Research Data Management Support Desk](https://vu.nl/en/employee/university-library/rdm-support-desk){target="_blank"}.
