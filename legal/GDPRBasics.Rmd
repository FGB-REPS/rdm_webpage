...
* genetic data
* biometric data (when used to identify a person such as fingerprints or iris scans)
* health data
* data about sexuality or sexual activity 
  
The vast majority of data collected within FGB will be considered "special" data even if they don't seem all that sensitive. For example, reaction time data, data from a FitBit and kinematic data are all considered health data, even when they are collected from healthy adults without any known medical concerns meaning that, legally, they are "special" data. "Special" data may help you identify situations that increase the risk of harm to your research subjects, but it's not always a one-to-one comparison. For more information on the risks of harm posed by the data, see the [Privacy Risks page](../Security/PrivacyRisks#harm){target="_blank"}.

The primary legal impact of "special" data is that if the data you plan to use are "special" under the GDPR, informed consent is likely the only [legal ground](#grounds) upon which to base your data processing. "Legitimate interests" is almost never a feasible option when working with "special" data. If informed consent is not feasible in your case, speak to the [FGB Privacy Officer](mailto:research.data.fgb@vu.nl) as soon as possible.
...
* Your starting point for support on privacy and research in the faculty is always the [FGB Privacy Officer](mailto:research.data.fgb@vu.nl). 
