...
1.	[Directly identifying personal data](https://fgb-rdm.nl/rdm/definitions/Definitions.html#directID){target="_blank"} (e.g. name, address, contact information) may be maintained for the entire duration of a [research project](https://fgb-rdm.nl/rdm/definitions/Definitions.html#researchproject){target="_blank"} if this information is required to carry out the project. For example, it may be necessary to: contact individuals about the next phase of the project; contact participants for a follow-up project, if they have given consent to be contacted for that reason; or for communication with participants’ caregivers or teachers who may need to provide supplementary information about participants, but who should not know the identification code under which participants are registered by the research team. Directly identifying personal data should be stored separately from other research data, at a higher level of security than [indirectly identifying information](https://fgb-rdm.nl/rdm/definitions/Definitions.html#indirectID){target="_blank"} and they should only be accessible to those individuals (usually research assistants and data managers) who absolutely require access to them and only for the period for which access is required (i.e. once access is no longer required, access rights should be revoked). 
    ...
    c.	Information on how to archive directly identifying personal data can be found in the [local FGB implementation of the DSW National Guidelines on Archiving](https://fgb-rdm.nl/rdm/archiving/ArchivingGuidelinesFull.html#section3){target="_blank"}.
    
<div class="NB">

NB: The Security Tips on [De-identification](https://fgb-rdm.nl/Security/Deidentification.html){target="_blank"} and on [Secure Storage](https://fgb-rdm.nl/Security/Storage.html){target="_blank"} provide additional guidance on how to handle directly identifying data.
