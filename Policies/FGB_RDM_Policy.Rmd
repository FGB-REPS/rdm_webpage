...
3.	Researchers are responsible for determining who is allowed to access (some of) the research data both within the faculty and between institutions. Principal investigators, senior researchers, project coordinators and project leaders should assist junior researchers and interns with this determination; advice from the FGB privacy champion and/or FGB research data steward can be requested, in cases of uncertainty.
    a.	Researchers are responsible for completing the appropriate agreements with external parties prior to starting a research project.[^4] 
...
**ARE WE STILL OK WITH THIS FGB VERSION OF THE DEPT HEAD ADDITIONAL RESPONSIBILITIES?**
...
**DO WE LIKE THE NEW ADDITION TO THE LAST POINT; THIS COVERS THE OPEN DATA SHARING PROPOSAL WORK THAT WE ARE DOING?**
...
14.	The director will sign contractual agreements with third parties, such as processing agreements with data processors, data sharing agreements and so forth, on behalf of the Stichting VU.
    a. For agreements under 50.000 euro, section heads can sign on behalf of the faculty director.

**DID I GET THE PART ABOUT THE SECTION HEADS' SIGNING POWER CORRECT?**
...
[^4]: See the [Workflow for processing standard privacy agreements](../Images/privacy_agreement_flow_fgb_2025.pdf){target="_blank"} for information on determining which agreements are needed and how to put those agreements in place. Further information on the necessary agreements and when they need to be applied is also found in the [GDPR Take-Home Points for Researchers](../legal/GDPRBasics.html#What_are_the_most_important_parts_of_the_GDPR_for_me_to_know){target="_blank"}.

[^5]: The faculty implementation of the [Code of Ethics for Research in the Social and Behavioural Sciences Involving Human Participants](https://assets.vu.nl/d8b6f1f5-816c-005b-1dc1-e363dd7ce9a5/c3fbf71b-9589-413c-bee5-8e9270b89d3c/ethiek-reglement-adh-landelijk-nov-2016_tcm263-810069.pdf){target="_blank"} outlines the ethical standards expected of every FGB researcher.
...
[^7]: In this section, the responsibilities of a department head are tied to the position of department head, not the individual. When one individual steps down from this role, the new individual takes over the responsibilities of their predecessor.
