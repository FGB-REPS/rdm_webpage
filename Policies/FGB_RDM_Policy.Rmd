...
[VU Research Data Management Policy of VU Amsterdam (Version 3.0, 2024)](https://rdm.vu.nl/public/policies-regulations/RDSM-policy-VU-EN-v3.0.pdf){target="_blank"}
...
[^2]: See [FGB Security Tips: The Basics](../Security/SecurityBasics.html){target="_blank"}, particularly [FGB Security Tips: Safe Practices for Students Working With Research Data](../Security/SecurityForStudents.html){target="_blank"} for more information.

[^3]: See [FGB Security Tips: The Basics](../Security/SecurityBasics.html){target="_blank"} and the associated [In-Depth Guides](../Security/SecurityBasics.html#indepth){target="_blank"}.
